...
extension ContentView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        VStack(alignment: .leading, spacing: __designTimeFloat("#2890.[1].[0].property.[0].[0].arg[1].value", fallback: 8.0)) {
            Spacer()
            HStack (spacing: __designTimeFloat("#2890.[1].[0].property.[0].[0].arg[2].value.[1].arg[0].value", fallback: 5.0)){
                Image(__designTimeString("#2890.[1].[0].property.[0].[0].arg[2].value.[1].arg[1].value.[0].arg[0].value", fallback: "Logo 2"))
                    ...
                    .modifier(StrokeStyle(cornerRadius: __designTimeInteger("#2890.[1].[0].property.[0].[0].arg[2].value.[1].arg[1].value.[0].modifier[3].arg[0].value.arg[0].value", fallback: 15)))
                Image(__designTimeString("#2890.[1].[0].property.[0].[0].arg[2].value.[1].arg[1].value.[1].arg[0].value", fallback: "Logo 3"))
                    .resizable(resizingMode: .stretch)
                    ...
                    .background(.regularMaterial,in: RoundedRectangle(cornerRadius: __designTimeInteger("#2890.[1].[0].property.[0].[0].arg[2].value.[1].arg[1].value.[1].modifier[4].arg[1].value.arg[0].value", fallback: 10), style:.continuous))
            }
            
            Text(__designTimeString("#2890.[1].[0].property.[0].[0].arg[2].value.[2].arg[0].value", fallback: "你好,swiftUI"))
                .font(.title)
                .fontWeight(/*@START_MENU_TOKEN@*/.bold/*@END_MENU_TOKEN@*/)
                .font(/*@START_MENU_TOKEN@*/.title/*@END_MENU_TOKEN@*/)
                .foregroundStyle(.linearGradient(colors: [.primary,.primary.opacity(__designTimeFloat("#2890.[1].[0].property.[0].[0].arg[2].value.[2].modifier[3].arg[0].value.arg[0].value.[1].modifier[0].arg[0].value", fallback: 0.5))], startPoint: .topLeading, endPoint: .bottomTrailing))
            Text(__designTimeString("#2890.[1].[0].property.[0].[0].arg[2].value.[3].arg[0].value", fallback: "20 sections - 3 hours"))
                .font(.title2)
                .foregroundColor(.secondary)
            Text(__designTimeString("#2890.[1].[0].property.[0].[0].arg[2].value.[4].arg[0].value", fallback: "这是一段长文本，我也不知道说什么祝我身体健康万事如意吧.我也不知道说什么祝我身体健康万事如意吧我也不知道说什么祝我身体健康万事如意吧我也不知道说什么祝我身体健康万事如意吧"))
                .font(.footnote)
        ...
        .background(.regularMaterial,in: RoundedRectangle(cornerRadius: __designTimeInteger("#2890.[1].[0].property.[0].[0].modifier[2].arg[1].value.arg[0].value", fallback: 30),style: .continuous))
        ...
        .background(Image(__designTimeString("#2890.[1].[0].property.[0].[0].modifier[7].arg[0].value.arg[0].value", fallback: "Blob 1")).offset(x: __designTimeInteger("#2890.[1].[0].property.[0].[0].modifier[7].arg[0].value.modifier[0].arg[0].value", fallback: 250),y: __designTimeInteger("#2890.[1].[0].property.[0].[0].modifier[7].arg[0].value.modifier[0].arg[1].value", fallback: -100)))
        .overlay(Image(__designTimeString("#2890.[1].[0].property.[0].[0].modifier[8].arg[0].value.arg[0].value", fallback: "Illustration 5"))
                    .resizable()
                    .aspectRatio(contentMode:.fit)
                    .frame(height: __designTimeInteger("#2890.[1].[0].property.[0].[0].modifier[8].arg[0].value.modifier[2].arg[0].value", fallback: 220))
                    .offset(x: __designTimeInteger("#2890.[1].[0].property.[0].[0].modifier[8].arg[0].value.modifier[3].arg[0].value", fallback: 26), y: __designTimeInteger("#2890.[1].[0].property.[0].[0].modifier[8].arg[0].value.modifier[3].arg[1].value", fallback: -98))
        )
    #sourceLocation()
    }
}
