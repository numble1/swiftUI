...
extension ContentView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        __designTimeSelection(VStack(alignment: .leading, spacing: __designTimeFloat("#2890.[1].[0].property.[0].[0].arg[1].value", fallback: 8.0)) {
            ...
            __designTimeSelection(Text(__designTimeString("#2890.[1].[0].property.[0].[0].arg[2].value.[2].arg[0].value", fallback: "你好,swiftUI"))
                .font(.title)
            ...
            __designTimeSelection(Text(__designTimeString("#2890.[1].[0].property.[0].[0].arg[2].value.[4].arg[0].value", fallback: "这是一段长文本，我也不知道说什么祝我身体健康万事如意吧.我也不知道说什么祝我身体健康万事如意吧我也不知道说什么祝我身体健康万事如意吧我也不知道说什么祝我身体健康万事如意吧"))
                .font(.footnote)
