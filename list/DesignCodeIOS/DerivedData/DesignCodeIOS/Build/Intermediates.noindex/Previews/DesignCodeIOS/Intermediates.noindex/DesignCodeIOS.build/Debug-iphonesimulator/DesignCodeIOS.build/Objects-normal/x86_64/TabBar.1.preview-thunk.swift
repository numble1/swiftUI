    ...
    @_dynamicReplacement(for: buttons) private var __preview__buttons: some View {
        ...
        ForEach(items){
            ...
            Button{
                ...
                VStack(spacing: __designTimeFloat("#10745.[1].[6].property.[0].[0].arg[1].value.[0].arg[1].value.[0].arg[0].value", fallback: 0.0)){
                    Image(systemName: item.icon)
                        .symbolVariant(.fill)
//                        .font(.body.bold())
                        .frame(width: __designTimeInteger("#10745.[1].[6].property.[0].[0].arg[1].value.[0].arg[1].value.[0].arg[1].value.[0].modifier[1].arg[0].value", fallback: 44), height: __designTimeInteger("#10745.[1].[6].property.[0].[0].arg[1].value.[0].arg[1].value.[0].arg[1].value.[0].modifier[1].arg[1].value", fallback: 29))
                    Text(item.text)
                        .font(.caption2)
                        .lineLimit(__designTimeInteger("#10745.[1].[6].property.[0].[0].arg[1].value.[0].arg[1].value.[0].arg[1].value.[1].modifier[1].arg[0].value", fallback: 1))
                }
...
extension TabBar {
    @_dynamicReplacement(for: topSlider) private var __preview__topSlider: some View {
        ...
        }.padding(.horizontal, __designTimeInteger("#10745.[1].[5].property.[0].[0].modifier[0].arg[1].value", fallback: 20))
    #sourceLocation()
    }
}
...
extension TabBar {
    @_dynamicReplacement(for: background) private var __preview__background: some View {
        ...
        .padding(.horizontal, __designTimeInteger("#10745.[1].[4].property.[0].[0].modifier[0].arg[1].value", fallback: 20))
    #sourceLocation()
    }
}
...
//            }
            ...
            HStack(spacing:__designTimeInteger("#10745.[1].[3].property.[0].[0].arg[0].value.[0].arg[0].value", fallback: 20)) {
                buttons
            }
//            .background(Color.cyan)
            ...
            .background(.thinMaterial, in: RoundedRectangle(cornerRadius: __designTimeInteger("#10745.[1].[3].property.[0].[0].arg[0].value.[0].modifier[4].arg[1].value.arg[0].value", fallback: 12), style: .continuous))
